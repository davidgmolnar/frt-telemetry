        ...
        appBar: AppBar(
          ...
          actions: [
            TextButton(
              ...
              child: const Text("System and Sensor checks"),
            ),
            TextButton(
              onPressed: () {
                _controller.animateTo(450, duration: const Duration(milliseconds: 700), curve: Curves.easeInOut);
              },
              child: const Text("Dynamics and Control"),
            ),
            TextButton(
              onPressed: () {
                _controller.animateTo(1000, duration: const Duration(milliseconds: 700), curve: Curves.easeInOut);
              },
              child: const Text("Power and MCUs"),
            ),
            TextButton(
              onPressed: () {
                _controller.animateTo(1500, duration: const Duration(milliseconds: 700), curve: Curves.easeInOut);
              },
              child: const Text("Steering and Lap"),
            ),
          ],
          ),
        body: ListView(
