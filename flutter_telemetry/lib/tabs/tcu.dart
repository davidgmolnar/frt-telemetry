...
TabLayout tcuBigLayout = TabLayout(
  shortcutLabels: const ["VDC Status", "Charts"],
  layoutBreakpoints: const [0, 900],
  layout: [
...
TabLayout tcuSmallLayout = TabLayout(
  shortcutLabels: const ["VDC Status", "Charts"],
  layoutBreakpoints: const [0, 1300],
  layout: [
    const Titlebar(title: "VDC Status",),
    Row(
      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
