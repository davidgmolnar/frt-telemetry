...
TabLayout mcuBigLayout = TabLayout(
  shortcutLabels: const ["AMK Status", "RPM and Temp"],
  layoutBreakpoints: const [0, 780],
  layout: [
...
TabLayout mcuSmallLayout = TabLayout(
  shortcutLabels: const ["AMK Front Status", "AMK Rear Status", "RPM and Temp"],
  layoutBreakpoints: const [0, 780, 1560],
  layout: [
