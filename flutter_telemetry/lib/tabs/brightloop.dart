...
TabLayout brightloopBigLayout = TabLayout(
  shortcutLabels: const ["Brightloop Charts", "Brightloop Status"],
  layoutBreakpoints: const [0, 700],
  layout: [
...
TabLayout brightloopSmallLayout = TabLayout(
  shortcutLabels: const ["Brightloop Charts", "Brightloop Status"],
  layoutBreakpoints: const [0, 1050],
  layout: [
    const Titlebar(title: "Brightloop Charts"),
    const WaveformChart(
      subscribedSignals: [
