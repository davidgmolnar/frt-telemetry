...
TabLayout dataloggerMobileLayout =
    TabLayout(layoutBreakpoints: [], shortcutLabels: [], layout: [
  Column(
    children: const [
      NumericPanel(subscribedSignals: [
        "ASMS_in",
        ...
        "to_EBS1_power_amplifier",
        "nSet_finish_state"
      ], colsize: 21, title: "Nonpogrammable Logic"),
      NumericPanel(subscribedSignals: [
        "Speed_target",
        "Speed_actual",
        "Motor_moment_target",
