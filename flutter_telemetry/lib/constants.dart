...
const Map<String, List<int>> hvCellIDRemap = { // left to right
  ...
  "Volt2": [88,85,82,79,101,98,95,92,114,111,108,105,127,124,121,118,140,137,134,131,153,150,147,144],
...
const Map<String,String> labelRemap = {  // _ by default space lesz
  ...
  "STA1_position": 'STA1',
  "STA2_position": 'STA2',
  "Brake_pressure_rear_ADC": 'BPS R ADC',
  "Brake_pressure_front_ADC": 'BPS F ADC',
  "Brake_pressure_rear": 'BPS R',
  "Brake_pressure_front": 'BPS F',
  ...
  "VIRT_BRIGHTLOOP_CH1_POWER": "24V Power out",
  "VIRT_BRIGHTLOOP_CH2_POWER": "12V Power out",
  "VIRT_BRIGHTLOOP_LV_MAH": "LV mAh out",
  "IDCDCOutput1UnBalance": "IO Current Unbalance",
  "VDCDCOutput1Average": "24V Voltage",
  "VDCDCOutput2Average": "12V Voltage",
  "IDCDCOutput1Average": "24V Current",
  "IDCDCOutput2Average": "12V Current",
  "VDCDCOutput1Max": "24V Voltage Max",
  "VDCDCOutput2Max": "12V Voltage Max",
  "IDCDCOutput1Max": "24V Current Max",
  "IDCDCOutput2Max": "12V Current Max",
  "VDCDCOutput1Min": "24V Voltage Min",
  "VDCDCOutput2Min": "12V Voltage Min",
  "IDCDCOutput1Min": "24V Current Min",
  "IDCDCOutput2Min": "12V Current Min",
  "VDCDCLV1Setpoint": "24V Setpoint",
  "VDCDCLV2Setpoint": "12V Setpoint",
  "VDCDCHVSetpoint": "HV Setpoint",
  "IDCDCLV1Limit": "24V Current Limit",
  "IDCDCLV2Limit": "12V Current Limit",
  "IDCDCHVLimit": "HV Current Limit",
  ...
  "VIRT_HV_CELL_VOLTAGE_MAX": "HV Cell Voltage MAX",
  "Brake_force_sensor_ADC": "BFS ADC"
};